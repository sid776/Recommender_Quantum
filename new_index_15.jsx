...
export default function CosmosReports() {
  ...
  // Grid height that ends neatly at the bottom of the viewport
  const gridHeight = "calc(100vh - 240px)"; // adjust if needed to align with your shell header
      ...
      <FormProvider {...methods}>
        <form className="flex flex-col gap-3">
          <div className="p-4 bg-white shadow-md rounded-lg" style={{ marginTop: -16 }}>
            {/* Header row (title left, COB + funnel right) */}
            <div className="flex items-center justify-between">
              <div className="text-lg font-bold">DQ Reports</div>

              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2">
                  <span className="text-sm font-semibold text-gray-700">COB:</span>
                ...
                <i
                  className={`ph ph-funnel cursor-pointer text-gray-700 hover:text-[#004832] relative top-[-2px]`}
