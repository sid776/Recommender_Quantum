    ...
    <FormProvider {...methods}>
      <Box className="mx-auto max-w-[1400px] p-4" style={{ overflow: "visible" }}>
        <Box
          ...
          style={{ position: "relative", zIndex: 1, overflow: "visible", marginTop: "-4px" }}
        >
          ...
          >
            <GridItem>
              <Text fontSize="sm" fontWeight="semibold" color="gray.700">Reports</Text>
            </GridItem>
            <GridItem>
              <Text fontSize="sm" fontWeight="semibold" color="gray.700">Report Date</Text>
            </GridItem>

            <GridItem minW="320px" position="relative" zIndex={10000} style={{ display: "flex", alignItems: "center" }}>
              <DynamicSelect
                id="reportName"
