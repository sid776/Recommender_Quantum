      ...
      <FormProvider {...methods}>
        <form className="flex flex-col gap-3 h-full">
          <div className="p-4 bg-white shadow-md rounded-lg flex flex-col h-full">
            ...
            {/* Grid: ONLY ONE HORIZONTAL SCROLLBAR (outer wrapper owns it) */}
            <div style={{ overflowX: "auto" }} className="flex-1">
              <Box
                className="ag-theme-alpine rounded-lg"
                style={{
                  width: "max-content",          // grid grows to needed width
              ...
              >
                <AgGridReact
                  ...
                  suppressHorizontalScroll={true}   // hide grid's own horizontal bar
                  domLayout="normal"
