...
function normalizeRows(rows) {
  return (rows || []).map((r) => {
    ...
    // Years (prefer plain 2021..2025; map Y2021..Y2025 into them)
...
/* Columns:
   order = Report Type (group) + Report Date + YEAR(2021..2025) + PREFERRED + extras
*/
function buildColumnDefs(rows) {
  ...
  return [...baseCols, ...yearCols, ...preferredCols, ...extras];
}
