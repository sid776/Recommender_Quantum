...
export default function CosmosReports() {
  ...
  return (
    <Box className="overflow-y-auto overflow-x-hidden" height="calc(100vh - 70px)">
      <FormProvider {...methods}>
        <form className="flex flex-col gap-3 h-full">
          <div className="p-4 bg-white shadow-md rounded-lg flex flex-col h-full">
            ...
            {/* Grid: Ag-Grid handles horizontal scroll (only one bar) */}
            <Box
            ...
            >
              <AgGridReact
                ...
                suppressHorizontalScroll={false}   // show ONLY the grid’s scrollbar
                domLayout="normal"
